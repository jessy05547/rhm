...
<?php $__env->startSection('content'); ?>
    <section class="dashboard-parent-ctx">
        ...
        <div class="ctx-partition-top">
            <div class="title-ctx">
                ...
                <p class="nombre-employe"><?php echo e($nombreEmployes); ?> employés travaillent actuellement.</p>
            </div>
            <div class="title-ctx">
                <h2 class="qte-employe">Nombre des absents</h2>
                <p class="nombre-employe"><?php echo e($nombreAbsents); ?> absents aujourd'hui</p>
            </div>
            <div class="title-ctx">
                <h2 class="qte-employe">La depense de l'entreprise</h2>
                <p class="nombre-employe">Ar <?php echo e($depense); ?>, c'est que l'entreprise doit payer.</p>
            </div>
        </div>
            ...
            <table class="dashboard-table-employe">
                ...
                <tbody class="dashboard-tbody-employe">
                    ...
                    <tr class="dashboard-tro-employe">
                        ...
                        <td class="dashboard-td-employe"><?php echo e($employe->departements->departement); ?></td>
    ...
    <script type="module">
        ...
        const postLabels = <?php echo json_encode($depenseLabels); ?>;
        const postValues = <?php echo json_encode($depenseValues); ?>;
